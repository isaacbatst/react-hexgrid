...
> This is just a fork for the [original package](https://www.npmjs.com/package/react-hexgrid) that merges [the pull request](https://github.com/Hellenic/react-hexgrid/pull/24) that updates Context API.
